...
func main() {
	...
	DashboardRoutes.Post("/categories", handlers.CreateCategory)
	DashboardRoutes.Put("/categories/:uid", handlers.UpdateCategory)
	DashboardRoutes.Delete("/categories/:uid", handlers.DeleteCategory)
	//Product
